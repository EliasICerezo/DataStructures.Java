 ...
 * implemented using separate chaining. Note that keys should define
 * {@link java.lang.Object#hashCode} method properly.
 *
 * @param <K>
 *            Type of keys.
 * @param <V>
...
public class SeparateChainingHashTable<K, V> implements HashTable<K, V> {
	 ...
	 * 
	 * @param numChains
	 *            Number of separate chains (linked lists).
	 * @param loadFactor
	...
	public void delete(K k) {
		int idx = hash(k);
		Node<K, V> prev = null, current = table[idx];
